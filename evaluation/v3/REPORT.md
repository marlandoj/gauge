...
All N01–N40 labels remain **proposed and pending human review** in [LABEL-REVIEW.md](LABEL-REVIEW.md). These are separate-author synthetic judgments, not human ground truth or an independent vendor panel. Approval of earlier H labels does not approve N labels.
...
The experiment is complete; promotion remains rejected. Remaining failures include elementary requests phrased without expected verbs, formal research taking bounded-edit/lookup branches, and a rollout request lacking recognized systemic wording. Do not patch those cases into frozen v3 or reuse N01–N40 as an unseen test. Further work needs a separately frozen candidate and fresh evaluation; more keyword coverage alone is insufficient. Human label review and separate live-routing authorization remain required.
